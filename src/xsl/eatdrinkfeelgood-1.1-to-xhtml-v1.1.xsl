     ...
     <xsl:template match = "e:course">
         <div>
             ...
             <div style = "font-size:.8em;">
                 <xsl:for-each select = "./*">
                     <xsl:choose>
                         <xsl:when test = "namespace-uri()='http://www.eatdrinkfeelgood.info/1.1/ns' and local-name()='recipe'">
                             <xsl:apply-templates select = "." />
                         </xsl:when>       
                         <xsl:when test = "namespace-uri()='http://www.w3.org/2001/XInclude' and local-name()='include'">
...
<!-- ======================================================================
     ...
     <xsl:template match = "e:directions">
         <div>
             ...
             <xsl:choose>
                 <xsl:when test = "namespace-uri(./*[position()=1])='http://www.eatdrinkfeelgood.info/1.1/ns' and local-name(./*[position()=1]) = 'step'">
...
<!-- ======================================================================
     ...
     <xsl:template match = "e:ingredients">
         <div>
             ...
             <xsl:choose>
                 <xsl:when test = "namespace-uri(./*[position()=1])='http://www.eatdrinkfeelgood.info/1.1/ns' and local-name(./*[position()=1]) = 'ing'">
